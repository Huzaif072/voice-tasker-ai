...
export function PwaStatus() {
  ...
  return <div className="fixed bottom-4 left-4 z-50 max-w-sm space-y-2 rounded-lg border border-slate-700 bg-slate-800 px-3 py-2 text-xs text-slate-200 shadow-lg" role="status">
